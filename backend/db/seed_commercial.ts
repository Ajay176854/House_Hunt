  ...
  try {
    ...
    for (let i = 0; i < TOTAL_PROPERTIES; i++) {
      ...
      const images = JSON.stringify([
        ...
        'https://images.unsplash.com/photo-1572025442646-866d16c84a54?auto=format&fit=crop&q=80&w=600'
      ]);
      ...
      await client.query(
        ...
        [
          uuidv4(), owner.id, 'Premium Commercial Space in ' + city, 'Excellent commercial space suitable for office or retail.',
          listingType, 'Commercial', price, priceUnit, depositAmount,
